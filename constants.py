SMALL = ['ArrowHead', 'Beef', 'BeetleFly', 'BirdChicken', 'Car', 'CBF', 'CinCECGTorso', 'Coffee', 'DiatomSizeReduction',
         'DistalPhalanxOutlineAgeGroup', 'DistalPhalanxTW', 'Earthquakes', 'ECG200', 'ECGFiveDays', 'FaceFour',
         'FacesUCR', 'Fish', 'GunPoint', 'Ham', 'Haptics', 'Herring', 'InlineSkate', 'Lightning2', 'Lightning7',
         'Mallat', 'Meat', 'MiddlePhalanxTW', 'MiddlePhalanxOutlineAgeGroup', 'MoteStrain', 'OliveOil', 'OSULeaf',
         'Plane', 'ShapeletSim', 'SonyAIBORobotSurface1', 'SonyAIBORobotSurface2', 'Symbols', 'ToeSegmentation1',
         'ToeSegmentation2', 'Trace', 'TwoLeadECG', 'Wine', 'Worms', 'WormsTwoClass']
...
ALL = ['PLAID', 'Plane', 'PowerCons', 'ProximalPhalanxOutlineAgeGroup',
       'ProximalPhalanxOutlineCorrect', 'ProximalPhalanxTW', 'RefrigerationDevices',
       'Rock', 'ScreenType', 'SemgHandGenderCh2', 'SemgHandMovementCh2',
       'SemgHandSubjectCh2', 'ShakeGestureWiimoteZ', 'ShapeletSim', 'ShapesAll',
       'SmallKitchenAppliances', 'SmoothSubspace', 'SonyAIBORobotSurface1',
